                                ...
                                <div class="table-responsive" style="max-height: 70vh; overflow-y: auto;">
                                    <table id="ReportTable" class="table table-bordered border-primary text-nowrap mh-100 overflow-auto">
                                        <thead style="text-align: center;">
                                            <tr>
                                                <th id="headerTable" class="border-primary" colspan="13"><?php echo $content_lang['dailyreport'] ?></th>
                                            </tr>
                                            <tr>
                                                <th class="border-primary"><?php echo $content_lang['list_number'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['bill_date'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['bill_No'] ?></th>
                                                ...
                                                <th class="border-primary"><?php echo $content_lang['deposit'] ?></th>
