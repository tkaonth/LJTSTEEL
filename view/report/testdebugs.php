...
?>
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow d-flex text-nowrap">
                        ...
                        <div class="d-flex flex-column mx-auto flex-md-row mx-md-0 col-md-12">
                            <div class="text-center my-auto">
                                <b class="align-middle pl-md-5">TESTDEBUGS</b>
                            </div>
                                ...
                                <div class="table-responsive" style="max-height: 70vh; overflow-y: auto;">
                                    ...
                                    <table id="ReportTable" class="table table-bordered border-primary text-nowrap mh-100 overflow-auto">
                                        <thead style="text-align: center;">
                                            <tr>
                                                <th id="headerTable" class="border-primary" colspan="18">ใบเสนอราคา tbl_Qaotation</th>
                                            </tr>
                                            <tr>
                                                <th class="border-primary">เลขที่ใบเสนอราคา</th>
                                                <th class="border-primary">รหัสลูกค้า</th>
                                                <th class="border-primary">วันที่ออกใบเสนอราคา</th>
                                                <th class="border-primary">ลำดับรายการ</th>
                                                <th class="border-primary">รหัสสินค้า</th>
                                                <th class="border-primary">หมายเลขคอยล์</th>
                                                <th class="border-primary">รายละเอียดสินค้า</th>
                                                <th class="border-primary">จำนวน</th>
                                                <th class="border-primary">ความยาวต่อหน่วย</th>
                                                <th class="border-primary">ความยาวรวม</th>
                                                <th class="border-primary">ความยาวรวม(คอยล์)</th>
                                                <th class="border-primary">ราคาต่อหน่วย</th>
                                                <th class="border-primary">ความกว้าง*ความสูง</th>
                                                <th class="border-primary">อัตราภาษี</th>
                                                <th class="border-primary">ภาษี</th>
                                                <th class="border-primary">ราคารวม</th>
                                                <th class="border-primary">รูปแบบการจ่าย</th>
                                    ...
                                    <table id="ReportTable" class="table table-bordered border-primary text-nowrap mh-100 overflow-auto">
                                        <thead style="text-align: center;">
                                            <tr>
                                                <th id="headerTable" class="border-primary" colspan="13">ใบขาย tbl_Sell_Summary</th>
                                            </tr>
                                            <tr>
                                                <th class="border-primary">วันที่</th>
                                                <th class="border-primary">รหัสลูกค้า</th>
                                                <th class="border-primary">เลขที่ใบขาย</th>
                                                <th class="border-primary">เลขที่อ้างอิง</th>
                                                <th class="border-primary">จำนวนสินค้า</th>
                                                <th class="border-primary">ภาษี</th>
                                                <th class="border-primary">ราคารวม</th>
                                                <th class="border-primary">ส่วนลด</th>
                                                <th class="border-primary">ราคารวม(หักส่วนลด,มัดจำ)</th>
                                                <th class="border-primary">ยอดจ่าย</th>
                                                <th class="border-primary">คงเหลือค้าง</th>
                                                <th class="border-primary">รูปแบบการจ่าย</th>
                                            </tr>
                                        </thead>
                                        <tbody id="BodyTable2" class="text-center">
                                    ...
                                    <table id="ReportTable" class="table table-bordered border-primary text-nowrap mh-100 overflow-auto">
                                        <thead style="text-align: center;">
                                            <tr>
                                                <th id="headerTable" class="border-primary" colspan="17">ใบรายการขาย tbl_Sell</th>
                                            </tr>
                                            <tr>
                                                <th class="border-primary">วันที่</th>
                                                <th class="border-primary">รหัสลูกค้า</th>
                                                <th class="border-primary">เลข Invoice</th>
                                                <th class="border-primary">เลข SellNo</th>
                                                <th class="border-primary">รหัสสินค้า</th>
                                                <th class="border-primary">รายละเอียดสินค้า</th>
                                                <th class="border-primary">ลำดับรายการ</th>
                                                <th class="border-primary">คอยล์</th>
                                                <th class="border-primary">ความยาว</th>
                                                <th class="border-primary">น้ำหนัก</th>
                                                <th class="border-primary">จำนวน</th>
                                                <th class="border-primary">ราคาต่อหน่วย</th>
                                                <th class="border-primary">อัตราภาษี</th>
                                                <th class="border-primary">ภาษี</th>
                                                <th class="border-primary">ราคารวม</th>
                                                <th class="border-primary">ใบเสนอราคา</th>
                                                <th class="border-primary">สาขา</th>
                                            </tr>
                                        </thead>
                                        <tbody id="BodyTable3" class="text-center">
                                    ...
                                    <table id="ReportTable" class="table table-bordered border-primary text-nowrap mh-100 overflow-auto">
                                        <thead style="text-align: center;">
                                            <tr>
                                                <th id="headerTable" class="border-primary" colspan="9">เงินมัดจำ tbl_Deposit</th>
                                            </tr>
                                            <tr>
                                                <th class="border-primary">วันที่</th>
                                                <th class="border-primary">เลขที่บิลมัดจำ</th>
                                                <th class="border-primary">เลข SellNo</th>
                                                <th class="border-primary">Dp_Description</th>
                                                <th class="border-primary">จำนวนเงินมัดจำ</th>
                                                <th class="border-primary">Dp_InvoiceNo</th>
                                                <th class="border-primary">รหัสลูกค้า</th>
                                                <th class="border-primary">รูปแบบการจ่าย</th>
                                                <th class="border-primary">สาขา</th>
                                            </tr>
                                        </thead>
                                        <tbody id="BodyTable4" class="text-center">
                                    ...
                                    <table id="ReportTable" class="table table-bordered border-primary text-nowrap mh-100 overflow-auto">
                                        <thead style="text-align: center;">
                                            <tr>
                                                <th id="headerTable" class="border-primary" colspan="10">ใบส่งของ tbl_Delivery_Invoice</th>
                                            </tr>
                                            <tr>
                                                <th class="border-primary">วันที่</th>
                                                <th class="border-primary">เลขที่ใบส่งของ</th>
                                                <th class="border-primary">ลำดับรายการ</th>
                                                <th class="border-primary">เลข Invoice</th>
                                                <th class="border-primary">รหัสสินค้า</th>
                                                <th class="border-primary">รายละเอียดสินค้า</th>
                                        ...
                                        <tbody id="BodyTable5" class="text-center">
    ...
    <script>
        ...
        var warnningmessage = document.getElementById("warnningmessage");
        var BodyTable = document.getElementById("BodyTable");
        var BodyTable2 = document.getElementById("BodyTable2");
        var BodyTable3 = document.getElementById("BodyTable3");
        var BodyTable4 = document.getElementById("BodyTable4");
        var BodyTable5 = document.getElementById("BodyTable5");
        var TableHeaderText = "<?php echo $content_lang['dailyreport']; ?>";
        var SelectBranch = document.getElementById("SelectBranch");
        var sumText = <?php echo json_encode($content_lang['sum']); ?>;
        var paidedText = <?php echo json_encode($content_lang['paided']); ?>;
        var behindhand_paymentText = <?php echo json_encode($content_lang['behindhand_payment']); ?>;
        var unpaidText = <?php echo json_encode($content_lang['unpaid']); ?>;
        var sum_deposit = 0;
        var sum_paid = 0;
        var sum_billprice = 0;
        var sum_money = 0;
        var sum_remaining = 0;
        var sum_tranferBank = 0;
        var sum_total = 0;
        var filterBranch = "All";
        var QaotationData = "";
        var SellData = "";
        var Sell_SummaryData = "";
        var DepositData = "";
        var DeliveryData = "";
    </script>
