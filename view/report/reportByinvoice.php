...
?>
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow d-flex text-nowrap">
                        ...
                        <div class="d-flex flex-column mx-auto flex-md-row mx-md-0 col-md-12">
                            <div class="text-center my-auto">
                                <b class="align-middle pl-md-5"><?php echo $content_lang['reportByinvoice'] ?></b>
                            </div>
                                ...
                                <div class="table-responsive" style="max-height: 70vh; overflow-y: auto;">
                                    <table id="ReportTable" class="table table-bordered border-primary text-nowrap mh-100 overflow-auto">
                                        <thead style="text-align: center;">
                                            <tr>
                                                <th id="headerTable" class="border-primary" colspan="15"><?php echo $content_lang['reportByinvoice'] ?></th>
                                            </tr>
                                            <tr>
                                                ...
                                                <th class="border-primary"><?php echo $content_lang['customer_ID'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['customer'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['money_net'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['deposit'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['discount'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['payment'] ?></th>
    ...
    <script src="../../js/reportByinvoice.js"></script>
    </html>