...
?>
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow d-flex text-nowrap">
                        ...
                        <div class="d-flex flex-column mx-auto flex-md-row mx-md-0 col-md-12">
                            <div class="text-center my-auto">
                                <b class="align-middle pl-md-5"><?php echo $content_lang['paymentReport'] ?></b>
                            </div>
                                ...
                                <div class="table-responsive" style="max-height: 70vh; overflow-y: auto;">
                                    <table id="ReportTable" class="table table-bordered border-primary text-nowrap">
                                        <thead style="text-align: center;">
                                            <tr>
                                                <th id="headerTable" class="border-primary" colspan="12"><?php echo $content_lang['paymentReport'] ?></th>
                                            </tr>
                                            <tr>
                                                <th class="border-primary"><?php echo $content_lang['list_number'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['bill_date'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['bill_number'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['invoice_No'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['bill_branch'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['customer'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['receive_payment'] ?></th>
                                                ...
                                                <th class="border-primary"><?php echo $content_lang['status_bill'] ?></th>
                                            </tr>
                                        </thead>
    ...
    <script>
        ...
        var TableHeaderText = "<?php echo $content_lang['paymentReport']; ?>";
