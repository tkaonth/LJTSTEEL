...
?>
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow d-flex text-nowrap">
                        ...
                        <div class="d-flex flex-column mx-auto flex-md-row mx-md-0 col-md-12">
                            <div class="text-center my-auto">
                                <b class="align-middle pl-md-5"><?php echo $content_lang['production_planning']; ?></b>
                            </div>
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="table-responsive" style="max-height: 70vh; overflow-y: auto;">
                                    <table id="ReportTable" class="table table-bordered border-primary text-nowrap mh-100 overflow-auto">
                                        <thead style="text-align: center;">
                                            <tr>
                                                <th id="headerTable" class="border-primary" colspan="12"><?php echo $content_lang['production_planning']; ?></th>
                                            </tr>
                                            <tr>
                                                <th class="border-primary"><?php echo $content_lang['branch'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['quotation_No'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['Pp_Planning_Date'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['Deadline'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['product_code'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['product_name'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['count'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['length'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['customer'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['Ref_Document'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['Coil_No'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['width'] ?></th>
                                            </tr>
                                        </thead>
                        ...
                        <div style="background-color: #727370;" class="d-flex gap-2">
                            ...
                            <span style="color : yellow;"><?php echo $content_lang['Order_production'] ?></span>
                            <span style="color : orange;"><?php echo $content_lang['Partially_produced'] ?></span>
                            <span style="color : #97ff4d;"><?php echo $content_lang['Order_production_complete'] ?></span>
                        </div>
                    </div>
                    <!-- /.container-fluid -->
                </div>
    ...
    <script>
        ...
        var TableHeaderText = "<?php echo $content_lang['production_planning']; ?>";
    ...
    <script src="../../js/showproduction_planning.js"></script>
    </html>