                                ...
                                <div class="table-responsive" style="max-height: 70vh; overflow-y: auto;">
                                    <table id="ReportTable" class="table table-bordered border-primary text-nowrap mh-100 overflow-auto">
                                        <thead style="text-align: center;">
                                            <tr>
                                                <th id="headerTable" class="border-primary" colspan="14"><?php echo $content_lang['quotation'] ?></th>
                                            </tr>
                                            <tr>
                                                <th class="border-primary"><?php echo $content_lang['branch'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['quotation_No'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['date'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['product_name'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['WxH'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['lengthperunit'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['count'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['unit'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['total_length'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['cut_fromCoil'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['PricePerUnit'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['Vat_rate'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['Vat_PerUnit'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['total_price'] ?></th>
                                            </tr>
                                        </thead>
