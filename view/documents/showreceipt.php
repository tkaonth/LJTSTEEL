...
?>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow d-flex text-nowrap">
                        ...
                        <div class="d-flex flex-column mx-auto flex-md-row mx-md-0 col-md-12">
                            <div class="text-center my-auto">
                                <b class="align-middle pl-md-5"><?php echo $content_lang['quotation'] ?></b>
                            </div>
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="table-responsive" style="max-height: 70vh; overflow-y: auto;">
                                    <table id="ReportTable" class="table table-bordered border-primary text-nowrap mh-100 overflow-auto">
                                        <thead style="text-align: center;">
                                            <tr>
                                                <th id="headerTable" class="border-primary" colspan="13"><?php echo $content_lang['quotation'] ?></th>
                                            </tr>
                                            <tr>
                                                <th class="border-primary"><?php echo $content_lang['list_number'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['branch'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['date'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['bill_number'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['customer'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['bill_type'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['moneyAmount'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['discount'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['total_priceafterdiscount'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['money'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['tranfer_bank'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['overdue'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['status'] ?></th>
                                            </tr>
                                        </thead>
                        ...
                        <!-- <div style="background-color: #727370;" class="d-flex gap-2">
                            <span style="color : white;"><?php echo $content_lang['status']." : " ?></span>
                            <span style="color : red;"><?php echo $content_lang['cancel'] ?></span>
                            <span style="color : yellow;"><?php echo $content_lang['wait_approve'] ?></span>
                            <span style="color : orange;"><?php echo $content_lang['approve'] ?></span>
                            <span style="color : #97ff4d;"><?php echo $content_lang['sold'] ?></span>
                        </div> -->
                    </div>
                    <!-- /.container-fluid -->
                </div>
    ...
    <script>
        ...
        var bill_deposit = <?php echo json_encode($content_lang['bill_deposit']); ?>;
        var bill_sale = <?php echo json_encode($content_lang['bill_sale']); ?>;
        var sum_deposit = 0;
        var sum_paid = 0;
        var sum_money = 0;
        var sum_remaining = 0;
    ...
    <script src="../../js/showreceipt.js"></script>
    </html>