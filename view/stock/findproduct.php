...
?>
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow d-flex text-nowrap">
                        ...
                        <div class="d-flex flex-column mx-auto flex-md-row mx-md-0 col-md-12">
                            <div class="text-center my-auto">
                                <b class="align-middle pl-md-5"><?php echo $content_lang['stock'] ?></b>
                            </div>
                                ...
                                <div class="table-responsive" style="max-height: 70vh; overflow-y: auto;">
                                    <table id="ReportTable" class="table table-bordered border-primary text-nowrap mh-100 overflow-auto">
                                        <thead style="text-align: center;">
                                            <tr>
                                                <th id="headerTable" class="border-primary" colspan="13"><?php echo $content_lang['stock'] ?></th>
                                            </tr>
                                            <tr>
                                                ...
                                                <th class="border-primary"><?php echo $content_lang['product_balance'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['product_price'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['keep_location'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['last_update'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['update_by'] ?></th>
                                            </tr>
                                        </thead>
    ...
    <script src="../../js/findproduct.js"></script>
    </html>