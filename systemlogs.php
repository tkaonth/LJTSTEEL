...
?>
                                    ...
                                    <table id="ReportTable" class="table table-bordered border-primary text-nowrap mh-100 overflow-auto">
                                        <thead style="text-align: center;">
                                            ...
                                            <tr>
                                                ...
                                                <th class="border-primary"><?php echo $content_lang['detail'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['device_name'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['ip_address'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['application'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['log_by'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['log_by_name'] ?></th>
                                                <th class="border-primary"><?php echo $content_lang['remark'] ?></th>
                                            </tr>
                                        </thead>
    ...
    <script>
        ...
        var TableHeaderText = "<?php echo $content_lang['stock']; ?>";
    ...
    <script src="./js/createbranchselect.js"></script>
