...
function tablerender() {
    ...
    for (let index = 0; index < dataReport.length; index++) {
        if (filterBranch == "All" && (dataReport[index]['i_Document'] == "Sell" || dataReport[index]['i_Document'] == "Invoice")) {
            ...
            sum_Ss_Grand_Total += dataReport[index]['Ss_Grand_Total'];
            if (Ss_Remaining > 0) {
            ...
            tr.innerHTML = `
                        ...
                        <td class="border-primary">` + formatDate(dataReport[index]['i_Date']) + `</td>
                        <td class="border-primary">` + dataReport[index]['Se_SellNo'] + `</td>
                        <td class="border-primary">` + dataReport[index]['Di_Delivery_ID'] + `</td>
            ...
            counter++;
        } else if (filterBranch == dataReport[index]['Se_BranchID'] && (dataReport[index]['i_Document'] == "Sell" || dataReport[index]['i_Document'] == "Invoice")) {
    ...
    trsum.innerHTML = `
                        ...
                        <td class="border-primary">` + sum_Ss_Grand_Total.toLocaleString() + `</td>
