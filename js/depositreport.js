...
function tablerender() {
    ...
    for (let index = 0; index < dataReport.length; index++) {
        if (filterBranch == "All" && dataReport[index]['i_Document'] == "Deposit") {
            ...
            if (dataReport[index]['i_Document'] == "Deposit") {
            ...
            counter++;
        } else if (filterBranch == dataReport[index]['Se_BranchID'] && dataReport[index]['i_Document'] == "Deposit") {
            var tr = document.createElement('tr');
            var branch_name = "";
            var deposit = 0;
            var money = 0;
